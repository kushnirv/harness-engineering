...
# провалы разом дороже, чем сэкономить двадцать. Замер 14.08: copier 2s · purity 2s ·
# bootstrap 11s · docs-reality 13s (последний внутри сам зовёт первые два — это не дубль по
